...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | ProblemX.AI',
    description: 'Replay this Agent conversation on ProblemX.AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | ProblemX.AI';
    const description =
      projectData.description ||
      'Replay this Agent conversation on ProblemX.AI';
