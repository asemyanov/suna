                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY ProblemX.AI
                      Corp (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                      United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE PROBLEMX.AI
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to ProblemX.AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the ProblemX.AI website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the ProblemX.AI website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@problemx.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ProblemX.AI is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@problemxai.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@problemxai.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All ProblemX.AI logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE PROBLEMX.AI WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      PROBLEMX.AI DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      by emailing us at{' '}
                      <a
                        href="mailto:legal@problemxai.com"
                        className="text-secondary hover:underline"
                      >
                        legal@problemxai.com
                      </a>
                      .
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at ProblemX.AI in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ProblemX.AI does not collect biometric or identifying
